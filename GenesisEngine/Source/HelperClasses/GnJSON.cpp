...
int GnJSONObj::GetInt(const char* name, int defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
...
float GnJSONObj::GetFloat(const char* name, float defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
		return json_object_get_number(_object, name);
	else
...
bool GnJSONObj::GetBool(const char* name, bool defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
...
const char* GnJSONObj::GetString(const char* name, const char* defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
...
math::float2 GnJSONObj::GetFloat2(const char* name, float2 defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
	{
		math::float2 number;
...
math::float3 GnJSONObj::GetFloat3(const char* name, float3 defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
	{
		math::float3 number;
...
math::float4 GnJSONObj::GetFloat4(const char* name, float4 defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
	{
		math::float4 number;
...
Quat GnJSONObj::GetQuaternion(const char* name, Quat defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
	{
...
Color GnJSONObj::GetColor(const char* name, Color defaultValue)
{
	if (json_object_has_value(_object, name) == 1)
	{
		Color color;
